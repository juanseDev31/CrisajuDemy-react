...
function Curso() {
  ...
  // Función para volver al inicio al hacer clic en "Salir"
  const handleSalir = () => {
    navigate("/");
  };

  // Base URL que usa Vite (importante para GitHub Pages)
      ...
      <main className="curso-container">
        ...
        <section className="curso-header">
          ...
          <div className="curso-video">
            <video controls>
              {/* Ruta relativa corregida con BASE_URL */}
              <source src={`${base}videos/intro.mp4`} type="video/mp4" />
        ...
        <section className="curso-descripcion">
          ...
          <ul>
            <li>Comprender la arquitectura y los componentes principales de Kubernetes.</li>
            <li>Instalar y configurar clústeres en diferentes entornos.</li>
            <li>Desplegar aplicaciones en contenedores de manera automatizada y segura.</li>
            <li>Gestionar volúmenes, almacenamiento persistente y configuraciones secretas.</li>
          </ul>

          <h3>Intensidad horaria</h3>
          <p><strong>Duración total:</strong> 60 horas</p>
          <p><strong>Modalidad:</strong> Virtual con sesiones en vivo + laboratorios prácticos</p>
          <ul>
        ...
        <section className="oferta">
          {/* Imagen corregida para funcionar en GitHub Pages */}
          <img src={`${base}images/oferta.png`} alt="Oferta Kubernetes" />
