...
function Home() {
  ...
  const base = import.meta.env.BASE_URL; // ✅ Clave para rutas en GitHub Pages
    ...
    <section id="tranding">
      ...
      <div className="container">
        <Swiper className="tranding-slider">
          {/* Cada SwiperSlide contiene una imagen, 
              se ajustan las rutas para funcionar correctamente en Pages */}
